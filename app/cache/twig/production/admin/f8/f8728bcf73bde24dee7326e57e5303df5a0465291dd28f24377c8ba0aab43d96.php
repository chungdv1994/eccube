...
/* __string_template__c48fa1bc7169dc08046542802c8044cb3e2f7f6f0dab986e3e38f5acf1482d91 */
class __TwigTemplate_e1ef8ca135f4d7adaa995bfcbb521d2be179fe9513a0cb1421cc52c56993edec extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__c48fa1bc7169dc08046542802c8044cb3e2f7f6f0dab986e3e38f5acf1482d91", 22);
        $this->blocks = array(
            'title' => array($this, 'block_title'),
            'sub_title' => array($this, 'block_sub_title'),
            'javascript' => array($this, 'block_javascript'),
            'main' => array($this, 'block_main'),
            '__internal_83fd2b2f55a7ce1e691a6fcdbb5079b07de75f044296aab53f0325d8d206cc88' => array($this, 'block___internal_83fd2b2f55a7ce1e691a6fcdbb5079b07de75f044296aab53f0325d8d206cc88'),
        );
    }
                    ...
                    <div id=\"authority_list\" class=\"table_list form-inlne\">
                        <div id=\"authority_list__body\" class=\"table-responsive\">
                            <table id=\"table-authority\" class=\"table table-striped table-condensed with-border\"
                                    data-prototype=\"";
        // line 79
        echo twig_escape_filter($this->env,         $this->renderBlock("__internal_83fd2b2f55a7ce1e691a6fcdbb5079b07de75f044296aab53f0325d8d206cc88", $context, $blocks));
        echo "\">
                                <thead>
...
";
    ...
    // line 79
    public function block___internal_83fd2b2f55a7ce1e691a6fcdbb5079b07de75f044296aab53f0325d8d206cc88($context, array $blocks = array())
    {
    ...
    {
        return "__string_template__c48fa1bc7169dc08046542802c8044cb3e2f7f6f0dab986e3e38f5acf1482d91";
    }
    ...
    {
        return new Twig_Source("", "__string_template__c48fa1bc7169dc08046542802c8044cb3e2f7f6f0dab986e3e38f5acf1482d91", "");
    }
}
